...
def baseUrl = 'https://' + CustomKeywords.'com.spe.Url.getBaseUrl'(url)
def executionProfile = RC.getExecutionProfile()
String siteType = siteType
String tealiumName = tealiumName
...
} else if (siteType == 'lp' || siteType.contains('-af')) {
...
def profileMC = siteType == 'Microsite'
def profileLP = siteType == 'lp' || siteType.contains('-af')
...
// partner_name
if (tealiumName.contains(utagDataText['partner_name'])) {
   KeywordUtil.markPassed('\nPASSED CASE AT partner_name: ' + 
   '\n| EXPECTED TEALIUM PROFILE/PARTNER_NAME: ' + tealiumName + '\n' + '| UTAG VALUE (CASE SENSITIVE): ' + utagDataText['partner_name'] + '\n' + '| PASSED\n' + '----------'
   )
} else {
   KeywordUtil.markFailed("\nFAILED CASE AT partner_name: " + 
	   "\n| EXPECTED PARTNER_NAME: " + tealiumName + 
...
} else if (siteType.contains('-af')) {
   println 'vvvvvvvvvv\n' + '| CASE - site_type: ' + '\n' + '| EXPECTED VALUE: Landing Page - Affiliate' + '\n' + '| VALUE: ' + utagDataText['site_type'] + '\n' + '| PASSED\n' + '----------'
}
else {
   KeywordUtil.markFailed("\nFAILED CASE AT SITE_TYPE: \n" +
	   "\n| Site Type listed as: " + siteType +
	   "\n| utag listed as: " + utagDataText['site_type'] +
