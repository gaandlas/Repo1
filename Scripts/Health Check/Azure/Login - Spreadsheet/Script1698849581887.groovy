...
// Specifically for the purpose of re-using the same production spreadsheet
def rootDomain = 'https://' + CustomKeywords.'com.spe.Url.getBaseUrl'(loginPage)
// By stripping any "request for information"  or landing page and UTM strings from URL
WebUI.navigateToUrl(rootDomain + '/wp-login.php')
