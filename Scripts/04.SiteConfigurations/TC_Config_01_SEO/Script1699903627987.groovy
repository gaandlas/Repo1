...
metaContent = WebUI.getAttribute(findTestObject('Pages/robotsmetatag'), 'content')

//Validate robots metatag
if (siteType == 'Microsite') {
	WebUI.verifyMatch(metaContent, 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1', false)
}else {
	WebUI.verifyMatch(metaContent, 'noindex, nofollow', false)
}
