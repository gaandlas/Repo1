...
/***
 * Submit a lead with Current Status = Transfer Student & related fields. 
 ***/
...
WebUI.selectOptionByIndex(findTestObject('Pages/UWACRFIForm/Status'), 2)
...
//Enter Anticipated Start Term
WebUI.selectOptionByIndex(findTestObject('Pages/UWACRFIForm/StartTerm'), 1)

//Enter Anticipated Start Year
WebUI.selectOptionByIndex(findTestObject('Pages/UWACRFIForm/StartYear'), 1)
